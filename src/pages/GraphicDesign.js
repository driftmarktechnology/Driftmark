    ...
    <section id="services" class="services section-bg">
      <div class="container">
        <div class="section-title">
          ...
          <p>Elevate Your Visual Storytelling: Where Art Meets Design</p>
        </div>
        <div class="section-title">
          <section>
            <h3>Logo Design</h3>
          ...
          <section>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <img
                  src="assets/img/graphic-design/graphic-2.jpg"
                  class="img-fluid animated"
                  alt=""
                />
              </div>
          ...
          <section>
            ...
            <div class="row">
              <div class="col-lg-6">
                <img
                  src="assets/img/graphic-design/graphic-3.jpg"
                  class="img-fluid animated"
                  alt=""
                />
              </div>
          ...
          <section>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <img
                  src="assets/img/graphic-design/graphic-4.jpg"
                  class="img-fluid animated"
                  alt=""
                />
              </div>
